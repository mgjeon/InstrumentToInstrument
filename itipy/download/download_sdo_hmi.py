...
class SDOHMIDownloader(BaseSDOJSOCDownloader):
    ...
    """
    def __init__(self, ds_path, email, n_workers=4, ignore_quality=False,
...
if __name__ == '__main__':
    ...
    downloader = SDOHMIDownloader(ds_path=args.ds_path, email=args.email, n_workers=args.n_workers)
